...
ActiveRecord::Schema.define(version: 2021_10_18_015240) do
  ...
  create_table "tests", force: :cascade do |t|
    ...
    t.integer "passage_timer", default: 0
  ...
  add_foreign_key "test_users", "questions", column: "current_question_id"
